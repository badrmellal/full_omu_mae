...
(e.g.\ nuScenes~\cite{nuscenes} or Waymo Open~\cite{waymo}) is left to future work.
...
label efficiency. Full end-to-end fine-tuning of the encoder is a natural extension that
